 ...
 */
class CeoAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    {
        return url('/ceo/admin-users/' . $this->getKey());
    }
    ...
    {
        return $this->getFirstMediaUrl('avatarCeo', 'thumb_150') ?: null;
    }
    ...
    {
        $this->addMediaCollection('avatarCeo')
            ->accepts('image/*');
    }
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $this->addMediaConversion('thumb_75')
            ...
            ->fit('crop', 75, 75)
            ->optimize()
            ->performOnCollections('avatarCeo')
            ->nonQueued();
