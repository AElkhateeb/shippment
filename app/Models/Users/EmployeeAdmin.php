 ...
 */
class EmployeeAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    {
        return url('/employee/admin-users/' . $this->getKey());
    }
    ...
    {
        return $this->getFirstMediaUrl('avatarEmployee', 'thumb_150') ?: null;
    }
    ...
    {
        $this->addMediaCollection('avatarEmployee')
            ->accepts('image/*');
    }
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $this->addMediaConversion('thumb_75')
            ...
            ->fit('crop', 75, 75)
            ->optimize()
            ->performOnCollections('avatarEmployee')
            ->nonQueued();
    ...
    public function branches() {
        return $this -> belongsToMany('App\Models\Branch','employee_branches','branch_id','employee_id','id','id');
    }
}
