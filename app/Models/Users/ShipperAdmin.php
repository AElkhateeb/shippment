 ...
 */
class ShipperAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    {
        return url('/shipper/admin-users/' . $this->getKey());
    }
    ...
    {
        return $this->getFirstMediaUrl('avatarShipper', 'thumb_150') ?: null;
    }
    ...
    {
        $this->addMediaCollection('avatarShipper')
            ->accepts('image/*');
    }
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $this->addMediaConversion('thumb_75')
            ...
            ->fit('crop', 75, 75)
            ->optimize()
            ->performOnCollections('avatarShipper')
            ->nonQueued();
