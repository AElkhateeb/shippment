 ...
 */
class AccountAdmin extends Authenticatable implements CanActivateContract, HasMedia
{
    use Notifiable;
    use CanActivate;
    use SoftDeletes;
    ...
    {
        return url('/account/admin-users/' . $this->getKey());
    }
    ...
    {
        return $this->getFirstMediaUrl('avatarAccount', 'thumb_150') ?: null;
    }
    ...
    {
        $this->addMediaCollection('avatarAccount')
            ->accepts('image/*');
    }
    ...
    public function registerMediaConversions(Media $media = null): void
    {
        ...
        $this->addMediaConversion('thumb_75')
            ...
            ->fit('crop', 75, 75)
            ->optimize()
            ->performOnCollections('avatarAccount')
            ->nonQueued();
