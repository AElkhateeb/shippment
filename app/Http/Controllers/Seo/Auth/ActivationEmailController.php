...
class ActivationEmailController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $activationBroker = 'seo_admins';
    ...
    public function __construct()
    {
        ...
        $this->activationBroker = config('seo-auth.defaults.activations');
    ...
    {
        if (config('seo-auth.self_activation_form_enabled')) {
            return view('seo.auth.activation.email');
        } else {
            abort(404);
        }
    }
