...
class UpdateAdminUser extends FormRequest
{
    ...
    {
        return Gate::allows('admin.manger-admin.edit', $this->adminUser);
    }
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'email' => ['sometimes', 'email', Rule::unique('manger_admins', 'email')->ignore($this->adminUser->getKey(), $this->adminUser->getKeyName()), 'string'],
