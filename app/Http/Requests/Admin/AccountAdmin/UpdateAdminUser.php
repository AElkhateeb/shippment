...
class UpdateAdminUser extends FormRequest
{
    ...
    {
        return Gate::allows('admin.account-admin.edit', $this->adminUser);
    }
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'email' => ['sometimes', 'email', Rule::unique('account_admins', 'email')->ignore($this->adminUser->getKey(), $this->adminUser->getKeyName()), 'string'],
