...
class UpdateAdminUser extends FormRequest
{
    ...
    {
        return Gate::allows('admin.ceo-admin.edit', $this->adminUser);
    }
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'email' => ['sometimes', 'email', Rule::unique('ceo_admins', 'email')->ignore($this->adminUser->getKey(), $this->adminUser->getKeyName()), 'string'],
