...
class FillPermissionsForReceiver extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReceiver constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.receiver',
            'admin.receiver.index',
            'admin.receiver.create',
            'admin.receiver.show',
            'admin.receiver.edit',
            'admin.receiver.delete',
            'admin.receiver.bulk-delete',
        ]);
