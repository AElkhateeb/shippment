...
class FillPermissionsForIdentity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIdentity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.identity',
            'admin.identity.index',
            'admin.identity.create',
            'admin.identity.show',
            'admin.identity.edit',
            'admin.identity.delete',
            'admin.identity.bulk-delete',
        ]);
