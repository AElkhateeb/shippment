...
class FillPermissionsForReceivere extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReceivere constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.receivere',
            'admin.receivere.index',
            'admin.receivere.create',
            'admin.receivere.show',
            'admin.receivere.edit',
            'admin.receivere.delete',
            'admin.receivere.bulk-delete',
        ]);
