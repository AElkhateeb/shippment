...
class FillPermissionsForSiteOption extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSiteOption constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.site-option',
            'admin.site-option.index',
            'admin.site-option.create',
            'admin.site-option.show',
            'admin.site-option.edit',
            'admin.site-option.delete',
            'admin.site-option.bulk-delete',
        ]);
