...
class FillPermissionsForMovementMethod extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMovementMethod constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.movement-method',
            'admin.movement-method.index',
            'admin.movement-method.create',
            'admin.movement-method.show',
            'admin.movement-method.edit',
            'admin.movement-method.delete',
            'admin.movement-method.bulk-delete',
        ]);
