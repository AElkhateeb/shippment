<!-- .rate-full -->
<section class="section-full primary-bg">
    <div class="container">
        <div class="section-title style8 white text-center">
            <h2 class="inline relative">
                <span class="shade f700 inline roboto">iPhone 6 Plus</span>
                <span class="title-color title-light text-uppercase">Wireframe</span>
            </h2>
        </div>
        <div class="row">
            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                <div class="sp-carousel-2">
                    <div class="service style10 light text-center margin-b-0 relative">
                        <div class="absolute-center">
                            <div class="icon">
                                <i class="et-line icon-strategy"></i>
                            </div>
                            <h3 class="title-light mb-25">Awesome Design</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do <br class="visible-lg"> eiusmod tempor incididunt ut labore et dolore magna aliqua  <br class="visible-lg">Ut enim ad minim veniam, quis nostrud exercitation.</p>
                        </div>
                    </div>
                    <div class="service style10 light text-center margin-b-0 relative">
                        <div class="absolute-center">
                            <div class="icon">
                                <i class="et-line icon-tools"></i>
                            </div>
                            <h3 class="title-light mb-25">Awesome Architecture</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do <br class="visible-lg"> eiusmod tempor incididunt ut labore et dolore magna aliqua  <br class="visible-lg">Ut enim ad minim veniam, quis nostrud exercitation.</p>
                        </div>
                    </div>
                </div>
